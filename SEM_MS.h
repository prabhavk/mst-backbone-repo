...
void SEM::SelectEdgeIncidentToVertexViaMLUnderGMModel(SEM_vertex * v) {
	// Add a new vertex 
...
void SEM::AddSitePatternWeights(vector <int> sitePatternWeightsToAdd) {
	...
	this->logLikelihoodConvergenceThreshold = pow(10,-8) * this->numberOfObservedVertices * this->sequenceLength;
}
